                    ...
                    ZStack {
                        VStack {
                            ...
                            Text("I'm Luan Fazolin, a Computer Science student from Brazil who really likes git - and who also happens to have a keen (and somewhat unexpected) interest on perfumes.")
                                ...
                                .padding()
                                .font(.custom("Noteworthy-Regular", size: 20))
                            Text("I developed this game as part of the 2024's WWDC's Swift Student Challenge.")
                                .foregroundColor(.black)
                                .multilineTextAlignment(.center)
                                .padding()
                                .font(.custom("Noteworthy-Regular", size: 20))
                            Text("Its objective is to help people that just started learning git commands, while also sharing a bit about perfume making in an environment inspired by the raw and playful aesthetics from the early 2000's internet games.")
                                .foregroundColor(.black)
                                .multilineTextAlignment(.center)
                                .padding()
                                .font(.custom("Noteworthy-Regular", size: 20))
